...
/* Hi! Here is the latest iteration of my job search materials. There hasn't been much change in my brand statement as that has been labelled "career ready" several months ago. I made minor changes to my GitHub profile per the previous suggestions. My LinkedIn profile has changed rather substantially. The biggest change here is that I have been able to get two recommendations and am expecting a possible third. My resume is reflecting changes recommended by Rebecca Klasson...mainly a more robust projects section as well as suggestions made after my previous submission. Note I have a single page version as well...Rebecca suggests that a two-page resume is better these days...finally my portfolio has seen many changes per previous suggestions to the bio, addition of a tech section, additional details in the portfolio page, and nice background images. Note I am still in the process of polishing the background. I am not exactly sure what is meant by "remove all unnecessary photos" in the previous suggestions. Which photos are unnecessary? I am completely open to revisions!
*/ 
